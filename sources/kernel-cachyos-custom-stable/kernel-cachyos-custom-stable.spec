...
%install
    ...
    ZSTD_CLEVEL=19 %make_build INSTALL_MOD_PATH="%{buildroot}" INSTALL_MOD_STRIP=1 DEPMOD=/bin/true modules_install
...
%changelog
* Tue Feb 24 2026 Custom Kernel Builder <builder@cachyos.org> - %{version}-%{release}
- Synced with upstream bieszczaders kernel-cachyos.spec
- Preserved custom 250Hz tick rate
- Fixed dracut scriptlet bug and added fallback default grubby configurations
